...
void updateDisplay(char message[], unsigned long epoch) {
    ...
    if (minute < 10)
        message[3] = '0';
    else message[3] = minute / 10+'0';
    message[4] = minute % 10+'0';
...
int timeToUpdate=0;
//unsigned long t1000 = 1000;
void loop() {
  if(millis()%1000==0){
  if(timeToUpdate>3600||epoch<9000000){
    timeToUpdate=0;
    epoch = getTimeEpoch();
  }
    else{
